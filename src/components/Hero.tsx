      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-5 items-center min-h-[80vh]">
          <div className="py-20 pb-12 lg:py-32">
            <h3 className="text-primary mb-3 font-semibold tracking-wide uppercase text-sm">
              Hello, I&apos;m
            </h3>
            <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold text-dark mb-4 tracking-tight">
              Jude <br />
              Clottey.
            </h1>
          ...
          <div className="hidden lg:flex items-center justify-center">
            ...
            <div className="relative w-full max-w-lg aspect-square flex items-center justify-center">
              ...
              <div
                className="absolute inset-8 bg-gradient-to-tl from-secondary/10 to-transparent rounded-full animate-pulse-slow"
              ...
              <div className="relative w-4/5 bg-[#1e1e1e] rounded-xl shadow-2xl overflow-hidden border border-white/10 flex flex-col transform hover:scale-105 transition-transform duration-500 z-10">
                ...
                <div className="p-8 font-mono text-sm leading-relaxed text-[#d4d4d4] flex-1 flex flex-col">
                  ...
                  <p className="pl-6">
                    ...
                    <span className="text-[#ce9178]">&apos;Jude Clottey&apos;</span>,
                  </p>
                  <p className="pl-6">
